...
# ===== B v4: Fix quantity_to_level index bug =====
# Since only one function changes, create v4 as v3 + fix
MDP_SOLVER_V4 = r"""function varargout = mdp_solver_v4(action, varargin)
...
write_file(DIR_B, "mdp_solver_v4.m", MDP_SOLVER_V4)
print("B v4: mdp_solver_v4.m written")
